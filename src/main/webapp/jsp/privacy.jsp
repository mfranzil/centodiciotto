...
<html lang="en">
<head>
    <title>Privacy - CentoDiciotto</title>
...
<div class="container mt-4">
    <div class="body-content">
        <div class="row">
            <div class="col-md">
                <div class="container">
                    <p>Prima che Lei ci fornisca i dati personali che La riguardano, in armonia con quanto previsto dal
                       Regolamento generale sulla protezione dei dati – Regolamento (UE) 2016/679 e dal D.Lgs. n. 196
                       del 30 giugno 2003, c.d. “Codice Privacy” come novellato dal D.lgs. n. 101 del 10 agosto 2018, è
                       necessario che Lei prenda visione di una serie di informazioni che possono aiutarLa a comprendere
                       le motivazioni per le quali verranno trattati i Suoi dati personali, spiegandoLe quali sono i
                       Suoi diritti e come li potrà esercitare.</p>
                    <p>La presente informativa descrive i trattamenti dei dati personali degli utenti che interagiscono
                       con il sito <em>web</em> www.centodiciotto.com (di seguito, sito del Fascicolo Sanitario
                       Elettronico e dei servizi <em>welfare</em> digitali o piattaforma o sito FSE). L'Informativa è
                       resa per il solo sito del Fascicolo Sanitario Elettronico e dei servizi <em>welfare</em> digitali
                       di CentoDiciotto e non si estende ad altri siti <em>web</em> eventualmente accessibili e
                       consultabili dall'utente mediante collegamento ipertestuale.</p>
                    <p>La presente informativa è soggetta ad aggiornamenti; gli utenti, pertanto, sono invitati a
                       verificarne periodicamente il contenuto.</p>
                    <p><b>1.&nbsp;&nbsp;Finalità e base giuridica del trattamento dei dati personali</b></p>
                    <p>Utilizzando la piattaforma e i relativi servizi, taluni Suoi dati personali, e tra questi anche
                       dati idonei a rivelare il Suo stato di salute riconducibili alle categorie particolari di dati di
                       cui all’art. 9 del Regolamento, saranno oggetto di trattamento in base alla vigente normativa in
                       materia di protezione dei dati personali.</p>
                    <p>L’impiego della piattaforma e dei relativi servizi, in particolare, è connesso al trattamento
                    ...
                    <p>Lei è informato che i dati di autenticazione e i dati di natura prettamente tecnica acquisiti
                       ...
                       strumentali all’erogazione del servizio, nonché per l’assolvimento di eventuali obblighi di
                       legge. In particolare:</p>
                    <ol>
                    ...
                    <p><b>2.&nbsp; Modalità del trattamento dei dati</b></p>
                    <p>Il trattamento sarà effettuato con l’ausilio di mezzi elettronici o comunque automatizzati, in
                       conformità ai principi di necessità e minimizzazione, e così per il solo tempo strettamente
                       richiesto per il conseguimento delle finalità perseguite. Il titolare del trattamento adotta
                       misure tecniche e organizzative adeguate a garantire un livello di sicurezza idoneo rispetto alla
                       tipologia di dati trattati.</p>
                    <p><b>3. Titolare del trattamento</b></p>
                    ...
                    <p>Il responsabile della protezione dei dati di CentoDiciotto può essere contattato inviando una
                        <em>e-mail</em> al seguente indirizzo di posta elettronica: rewqasdfcxz11@gmail.com</p>
                    <p><b>5.&nbsp; Natura del conferimento dei dati</b></p>
                    <p>Il conferimento dei dati di natura prettamente tecnica, che potranno essere acquisiti,
                       in modo del tutto automatizzato, dai sistemi informatici interrogati dal Suo dispositivo,
                       nonché dei dati relativi alla Sua autenticazione deve intendersi come obbligatorio. Il mancato
                       conferimento di detti dati comporta l’impossibilità di accedere al <em>software</em> e ai servizi
                       presenti nel Fascicolo Sanitario Elettronico.</p>
                    <p><b>6.&nbsp; Destinatari e ambito di comunicazione dei dati</b></p>
                    <p>I Suoi dati saranno trattati esclusivamente dal titolare del trattamento, dai responsabili
                       nominati, quali CentoDiciotto, fornitore di servizi IT della Regione, ed eventuali ulteriori
                       fornitori nominati, e dal relativo personale appositamente istruito al trattamento e alla
                    ...
                    <p>Le operazioni di trattamento poste in essere dal <em>software</em> e dal relativo servizio
                       richiedono un periodo di conservazione pari al periodo di utilizzo del <em>software</em> e del
                       relativo servizio. I dati di <em>log </em>degli accessi non persistono per più di 12 mesi e
                       vengono cancellati immediatamente dopo la loro aggregazione.</p>
                    <p><b>9.&nbsp; Processi automatizzati e profilazione</b></p>
                    <p>I dati personali conferiti non sono soggetti ad alcun processo decisionale interamente
                       automatizzato, ivi compresa la profilazione, che possa produrre nei Suoi confronti effetti
                       giuridici, ovvero che possa incidere significativamente sulla Sua persona.</p>
                    <p><b>10.&nbsp; Diritti dell'interessato</b></p>
                    <p>Al fine dell’esercizio dei diritti di cui agli artt. 15 e ss. del Reg. UE 679/2016,
                       l’interessato può inviare una comunicazione all'attenzione del Supporto Normativo Protezione Dati
                       Personali, scrivendo all’indirizzo di posta elettronica rewqasdfcxz11@gmail.com.</p>
                    <p>È sempre possibile, inoltre, esercitare il diritto di proporre reclamo ad un’Autorità
                       di Controllo.</p>
                </div>
            </div>
        </div>
