...
<html lang="en">
<head>
    <title>405 Method Not Allowed - CentoDiciotto</title>
...
<div class="container">
    <div class="jumbotron mt-4">
        ...
        <p class="lead">We're sorry.
                        Access to the requested resource was denied using this method.</p>
...
<div class="container">
    <div class="body-content">
        <div class="row">
            <div class="col-md-6">
                <h2>What happened?</h2>
                <p class="lead">A 405 implies the resource was present on the web server, but was accessed using an
                                unauthorized method.</p>
            </div>
            <div class="col-md-6">
                <h2>What can I do?</h2>
